...
const MIKETZ_ENGLISH_MAP = {
  "אֲבִיכֶם": "your father",
  "אִישׁ": "man; each one",
  "אֶל": "to; toward",
  "אָמַר": "said",
  "אַמְתַּחְתּוֹ": "his sack",
  "אֲנַחְנוּ": "we",
  ...
  "אִתָּם": "with them",
  "אֹתָנוּ": "us",
  "בְּאַמְתַּחַת": "in the sack of",
  "בְּאַמְתְּחֹתֵינוּ": "in our sacks",
  "בַּגָּדוֹל": "with the oldest",
  "בְּיָדוֹ": "in his hand",
  "בֵּית": "house of",
  "בֵּיתָה": "to the house",
  "בֵּיתוֹ": "his house",
  "בִּנְיָמִין": "Benjamin",
  "בִּנְיָמִן": "Benjamin",
  "בַּצָּהֳרָיִם": "at noon",
  "בַּתְּחִלָּה": "at first; at the beginning",
  "גַּם": "also",
  "דְּבַר": "matter; word",
  "הָאִישׁ": "the man",
  "הָאֱלֹהִים": "God",
  "הָאֲנָשִׁים": "the men",
  "הָבֵא": "bring",
  "הַבָּיְתָה": "into the house",
  "הַגָּבִיעַ": "the cup",
  "הוּא": "he",
  "הוּבְאוּ": "they were brought",
  "הַזֶּה": "this",
  "הֵחֵל": "he began",
  "הַכֶּסֶף": "the silver; the money",
  "הֲלוֹא": "surely; is it not",
  "הַמַּעֲשֶׂה": "the deed",
  "הִנֶּנּוּ": "here we are; behold us",
  "הָעִירָה": "to the city",
  "הַשָּׁב": "that was returned",
  "וְאֶחָיו": "and his brothers",
  "וְאֶת": "and (object marker)",
  "וְאַתֶּם": "and you (pl.)",
  "וּבַקָּטֹן": "and with the youngest",
  "וְהוּא": "and he",
  "וְהָכֵן": "and prepare",
  "וּטְבֹחַ": "and slaughter",
  "וַיֹּאמֶר": "and he said",
  "וַיֹּאמְרוּ": "and they said",
  "וַיָּבֵא": "and he brought",
  "וַיָּבֹא": "and he came",
  "וַיּוֹרִדוּ": "and they brought down",
  "וַיְחַפֵּשׂ": "and he searched",
  "וַיִּירְאוּ": "and they were afraid",
  "וַיְמַהֲרוּ": "and they hurried",
  "וַיִּמָּצֵא": "and it was found",
  "וַיַּעֲמֹס": "and he loaded",
  "וַיַּעַשׂ": "and he did",
  "וַיִּפְּלוּ": "and they fell",
  "וַיִּפְתְּחוּ": "and they opened",
  "וַיִּקְרְעוּ": "and they tore",
  "וַיַּרְא": "and he saw",
  "וַיָּשֻׁבוּ": "and they returned",
  "וּלְהִתְנַפֵּל": "and to fall upon",
  "וְלָקַחַת": "and to take",
  "וּמַה": "and what",
  "זֹאת": "this",
  "חָלִילָה": "far be it",
  "חֲמֹרוֹ": "his donkey",
  "חֲמֹרֵינוּ": "our donkeys",
  "טֶבַח": "slaughter; meal",
  "יֹאכְלוּ": "they will eat",
  "יְדַעְתֶּם": "you knew",
  "יְהוּדָה": "Judah",
  "יִהְיֶה": "he shall be",
  "יוֹסֵף": "Joseph",
  "יְנַחֵשׁ": "he surely divines",
  "כַּאֲשֶׁר": "as; just as",
  "כִּי": "for; because",
  "כִּלָּה": "he finished",
  "כָּמֹנִי": "like me",
  "לַאדֹנִי": "to my lord",
  "לַאֲשֶׁר": "to the one who",
  "לָהֶם": "to them",
  "לְהִתְגֹּלֵל": "to roll ourselves against",
  "לִּי": "to me",
  "לַעֲבָדִים": "as slaves",
  "לְפָנָיו": "before him",
  "לְשָׁלוֹם": "in peace",
  "מַה": "what",
  "מָה": "what",
  "מוּבָאִים": "we are being brought",
  "מֵעֲשׂוֹת": "from doing",
  "מָצָא": "found",
  "נֹּאמַר": "shall we say",
  "נְּדַבֵּר": "shall we speak",
  "נַחֵשׁ": "to divine",
  "נִמְצָא": "was found",
  "נִּצְטַדָּק": "can we justify ourselves",
  "עָבֶד": "servant",
  "עֲבָדֶיךָ": "your servants",
  "עֲבָדִים": "servants; slaves",
  "עוֹדֶנּוּ": "still",
  "עֲוֹן": "guilt; iniquity",
  "עַל": "on; concerning",
  "עֲלוּ": "go up",
  "עָלֵינוּ": "upon us",
  "עֲשִׂיתֶם": "you did",
  "שָׁם": "there",
  "שִׂמְלֹתָם": "their garments",
};

function getMiketzEnglish(hebrew) {
  const gloss = MIKETZ_ENGLISH_MAP[hebrew];
  if (!gloss) throw new Error(`Missing Miketz English gloss for: ${hebrew}`);
  return [gloss];
}
...
function buildMiketzRows() {
  const group1 = extractUniqueWords(MIKETZ_1_TEXT).map((hebrew) => ({
    ...
    english: getMiketzEnglish(hebrew),
